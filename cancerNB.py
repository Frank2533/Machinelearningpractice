...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 13 13:07:50 2022
...
df = pd.read_csv("/media/akash/5E820BDA820BB595/CDAC ACTS/Machine Learning/Cases/Cancer/Cancer.csv")
dum_df = pd.get_dummies(df, drop_first=True)
param = dum_df.iloc[:,1:-1]
...
result_pred_proba = mul.predict_proba(param_test)[:,1]
...
print(roc_auc_score(result_test,result_pred_proba))
